...
describe('Tag e2e test', () => {
    ...
    it('should load Tags', () => {
        ...
        expect(tagComponentsPage.getTitle())
            .toMatch(/blogApp.tag.home.title/);
    ...
    it('should load create Tag dialog', () => {
        ...
        expect(tagDialogPage.getModalTitle())
            .toMatch(/blogApp.tag.home.createOrEditLabel/);
        tagDialogPage.close();
    });
    ...
    it('should create and save Tags', () => {
        ...
        tagDialogPage.setDescritpionInput('descritpion');
        expect(tagDialogPage.getDescritpionInput()).toMatch('descritpion');
        tagDialogPage.save();
